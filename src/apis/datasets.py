...
ns_datasets = Namespace('datasets', description='Custom or Trails datasets that provided by MetisAI.')
...
default_datasets = ['cypto', 'covid', 'realestate', 'socialnetworkrelations', 'sports', 'socialissues']
@ns_datasets.route('/')
